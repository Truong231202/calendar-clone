      ...
      <div className="flex-1 overflow-y-auto px-2 py-5">
        ...
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-[2px] pr-[2px] pl-[8px]">
            ...
            <button type="button" className="flex items-center justify-center w-6 h-6 text-neutral-400 hover:text-neutral-600 hover:bg-neutral-100 rounded transition-colors">
        ...
        <div className="flex flex-col border-t border-neutral-200 py-[10px] px-2">
          <div
